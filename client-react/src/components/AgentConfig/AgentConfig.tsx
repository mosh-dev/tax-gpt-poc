  ...
  return (
    <div className="p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="px-3 md:px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            ...
            <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mt-1">
              Upload documents to enhance the agent's knowledge. Files are automatically processed and indexed for
              semantic search.
            </p>
          </div>
          ...
          <div className="p-3 md:p-4">
            ...
            {kbSuccess && (
              <div
                className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-sm text-green-700 dark:text-green-400">
                {kbSuccess}
              </div>
            )}
                  ...
                  <div className="mb-3">
                    ...
                    <div className="space-y-2 max-h-40 overflow-y-auto">
                      {selectedFiles.map((file, index) => (
                        <div key={index}
                             className="flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 p-2 rounded">
                          <svg className="w-4 h-4 text-blue-600 dark:text-blue-400 flex-shrink-0" fill="none"
            ...
            {loadingKB ? (
              <div className="flex items-center justify-center py-8">
                <div
                  className="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600 dark:border-blue-500"></div>
              </div>
        ...
        {/* KB Help text */}
        <div
          className="mt-4 p-3 md:p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
          <h3 className="text-xs md:text-sm font-medium text-purple-800 dark:text-purple-400 mb-2">How Knowledge Base
            works:</h3>
        ...
        {/* Instructions editor */}
        <div
          className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm mt-8">
          <button
        ...
        {/* Help text */}
        <div
          className="mt-4 p-3 md:p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <h3 className="text-xs md:text-sm font-medium text-blue-800 dark:text-blue-300 mb-2">Tips for writing good
            instructions:</h3>
